...
namespace Srvtools
{
    ...
    public class ServerConfig
    {
        ...
        private static void LoadDomainConfig()
        {
            ...
            if (File.Exists(s))
            {
                ...
                try
                {
                    ...
                    DomainPath = xn.Attributes["Path"].Value;
                    DomainUser = xn.Attributes["User"].Value;
                    DomainPassword = Decrypt(DomainUser, xn.Attributes["Password"].Value);
                }
                catch
                {
                    File.Delete(s);
