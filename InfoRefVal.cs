...
namespace Srvtools
{
    ...
    public class InfoRefVal : InfoBaseComp, ISupportInitialize, IUseSelectCommand
    {
        ...
        ////Wei-Da,Wang 2004/09/29 POCA

        private bool _checkDataSpace = false;
        [Category("TTRI")]
        public bool checkDataSpace
        {
            get { return _checkDataSpace; }
            set { _checkDataSpace = value; }
        }
        ...
        private bool _TextboxSelectType = false;
        [Category("TTRI")]
        public bool TextboxSelectType
        {
            get { return _TextboxSelectType; }
            set { _TextboxSelectType = value; }
        }
        ...
        /// Jay 20160830
        /// </summary>
        private WhereItemCollection _AddKeycolumns;
        [Category("Infolight"),
        Description("Specifies the columns in where part to get data")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public WhereItemCollection AddKeycolumns
        {
            get { return _AddKeycolumns; }
        ...
        public object[] CheckValid_And_ReturnDisplayValue(ref string strValue, bool bReport, bool Repaint)
        {
            ...
            if ((strValue == null || strValue == "") && _checkDataSpace == false) //Wei-Da,Wang  2004/09/29 
            {
