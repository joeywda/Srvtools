...
namespace Srvtools
{
    ...
    public partial class InfoDateTimeBox : UserControl, IWriteValue
    {
        ...
        public InfoDateTimeBox()
        {
            ...
            this.maskedTextBox.Enter += new EventHandler(maskedTextBox_Enter);
        ...
        public Color EnterBackColor
        {
            get
            {
                return this.maskedTextBox.EnterColor;
            }
            set
            {
                this.maskedTextBox.EnterColor = value;
            }
        }
        //2016/7/29 JAY
        ...
        public Color BackColorDisabled
        {
            get
            {
                return this.maskedTextBox.BackColorDisabled;
            }
            set
            {
                this.maskedTextBox.BackColorDisabled = value;
            }
        }
        ...
        public Color ForeColorDisabled
        {
            get
            {
                return this.maskedTextBox.ForeColorDisabled;
            }
            set
            {
                this.maskedTextBox.ForeColorDisabled = value;
            }
        }

        [Category("TTRI"),Description("Get Enterbackcolor By Method")]
        public string EnterBackColorFixed
        {
            get
            {
                return this.maskedTextBox.EnterColorGetFixed;
            }
            set
            {
                this.maskedTextBox.EnterColorGetFixed = value;
            }
        }
