...
namespace Srvtools
{
    ...
    public partial class InfoComboBox : ComboBox, ISupportInitialize, IUseSelectCommand,IWriteValue
	{
        ...
        public InfoComboBox()
		{
            ...
            //2016/7/29 JAY
            this.Leave += new EventHandler(InfoComboBox_Leave);
            this.Enter += new EventHandler(InfoComboBox_Enter);
            // end
        }
        ...
        public void InfoComboBox_Leave(object sender, EventArgs e)
        {
            this.BackColor = oldBackColor; //Color.LightGray;  //JAY
        }

        public void InfoComboBox_Enter(object sender, EventArgs e)
        {
