...
namespace Srvtools
{
    public partial class InfoRefButton : System.Windows.Forms.Button
    {
        ...
        //---2017/8/3 Leslie：新增Panel標題
        private string _panelTitle = "";
        [Category("ttri"), DefaultValue("")]
        public string PanelTitle
        {
            get { return _panelTitle; }
            set { _panelTitle = value; }
        }

        //---2017/8/3 Leslie：新增分隔符號
        private string _filterChr = ",";
        [Category("ttri"), DefaultValue(","), Description("多選時，使用之分隔符號")]
        public string FilterChr
        {
            get { return _filterChr; }
            set { _filterChr = value; }
        }

        //---2017/8/3 Leslie：新增快速查詢時，是否自動查詢
        private bool _autoQuery = true;
        [Category("ttri"), DefaultValue(true), Description("快速查詢(不需按下查詢按鈕)")]
