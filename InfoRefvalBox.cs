...
namespace Srvtools
{
    ...
    public partial class InfoRefvalBox : UserControl, ISupportInitialize, IGetValues, IWriteValue
    {
        ...
        public Color EnterBackColor
        {
            get
            {
                return this.InTextBox.EnterColor;
            }
            set
            {
                this.InTextBox.EnterColor = value;
            }
        }
        //2016/7/29 JAY
        ...
        public string EnterColorGetFixed
        {
            get
            {
                return this.InTextBox.EnterColorGetFixed;
            }
            set
            {
                this.InTextBox.EnterColorGetFixed = value;
            }
        }
        ...
        /// 琌盢ヘ玡戈暗like(%)
        /// </summary> 
        private bool _FilterInit = false;
        [Browsable(true), Description("琌縵匡﹍(%)")]
