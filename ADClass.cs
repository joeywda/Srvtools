...
namespace Srvtools
{
    ...
    public class ADClass
    {
        ...
        public static bool TestDirecoryOjbect()
        {
        ...
        public static List<ADGroup> GetADUserForGroup()
        {
        ...
        public static List<ADUser> GetADAllUser()
        {
        ...
        public static DirectoryEntry GetUser(string userid, string password)
        {
