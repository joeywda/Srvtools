    ...
    public class InfoNavigator : BindingNavigator, ISupportInitialize, IGetValues
    {
        ...
        protected virtual void OnBeforeEndInit()
        {
            ...
            if (this.BindingSource != null)
            {
                ...
                {
                    if(infoBindingSource.Site==null)  //2014.11.11  POCA, SamWu, 解決 IBS 會掉的問題
                    {
                       Component myComponent=new Component();
                       Container myContainer=new Container();
                       myContainer.Add(myComponent);
                       infoBindingSource.Site=myComponent.Site;
                    }   //2014.11.11  POCA, SamWu, 解決 IBS 會掉的問題
        ...
        private void OnCopyClick(object sender, EventArgs e)
        {
            ...
            if (!argsbeforeclick.Cancel)
            {
                ...
                //Leslie:如果showDialog取消就不執行Afterclick
                //OnAfterItemClick(new AfterItemClickEventArgs("Copy"));
            }
        }
        ...
        private void OnDeleteClick(object sender, EventArgs e)
        {
            ...
            if (!argsbeforeclick.Cancel)
            {
                //DoDelete(); //2016/8/13 Leslie:修改為，若設定確認刪除，按否時，不跑OnAfterItemClick
        ...
        private bool DoDelete()  //2016/8/13 Leslie:修改為，若設定確認刪除，按否時，不跑OnAfterItemClick---原程式: private void DoDelete()
        {
            if (this.BindingSource.Current != null)
            {
                ...
                if (this.SureDelete)
                {
                    ...
                    {
                        //2016/8/13 Leslie:修改為，若設定確認刪除，按否時，不跑OnAfterItemClick
                        if (MessageBox.Show(this.SureDeleteText, "Confirm", MessageBoxButtons.YesNo) == DialogResult.Yes)
                        {
                        ...
                        } else { return false; } //2016/8/13 Leslie:修改為，若設定確認刪除，按否時，不跑OnAfterItemClick
