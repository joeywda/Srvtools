...
namespace Srvtools
{
    ...
    public class InfoDataGridViewRefValColumn : DataGridViewTextBoxColumn
    {
        ...
        public CharacterCasing CharacterCasing
        {
            get
            {
                return (this.CellTemplate as InfoDataGridViewRefValCell).CharacterCasing;
            }
            set
            {
                ...
                if (base.DataGridView != null)
                {
                    ...
                    for (int index = 0; index < rowCount; ++index)
                    {
                        ...
                        InfoDataGridViewRefValCell cell = row.Cells[base.Index] as InfoDataGridViewRefValCell;
                        if (cell != null)
                        {
        ...
        public bool FilterInit
        {
            get
            {
                return (this.CellTemplate as InfoDataGridViewRefValCell).FilterInit;
            }
            set
            {
                InfoDataGridViewRefValCell template = this.CellTemplate as InfoDataGridViewRefValCell;
        ...
        public class InfoDataGridViewRefValCell : DataGridViewTextBoxCell
        {
            ...
            protected override void OnMouseDown(DataGridViewCellMouseEventArgs e)
            {
                ...
                try
                {
                    ...
                    if (this.Selected)
                    {
                        if (e.X <= this.Size.Width && e.X >= x && !this.DataGridView.Columns[this.ColumnIndex].ReadOnly)
                        {
            ...
            public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
            {
                ...
                ctrl._FilterInit = this._FilterInit;
            }
            ...
            public override object Clone()
            {
                ...
                cell._CharacterCasing = this._CharacterCasing;
                cell._FilterInit = this._FilterInit;
                return cell;
            }
        }
        ...
        public class InfoDataGridViewRefValCellEditingControl : InfoRefValForGrid, IDataGridViewEditingControl
        {
            ...
            public CharacterCasing _CharacterCasing; /*2014/10/13ttri*/
            public bool _FilterInit;
                ...
                : base()
            {
                InnerTextBox.Validating += new System.ComponentModel.CancelEventHandler(InnerTextBox_Validating);
                  InnerTextBox.Leave += new EventHandler(InnerTextBox_Leave);   /*2014/10/13ttri*/
                
            }

            /*2014/10/13ttri*/
            public void InnerTextBox_Leave(object sender, EventArgs e)
            {
               
                if (_CharacterCasing == CharacterCasing.Upper )
                {
                    InnerTextBox.Text = InnerTextBox.Text.ToUpper();           
                }
                else if (_CharacterCasing == CharacterCasing.Lower)
                {               
                    InnerTextBox.Text = InnerTextBox.Text.ToLower();                  
                }
            }
            /*2014/10/13ttri*/
            ...
            protected override void OnEnter(EventArgs e)
            {
                ...
                //2016/9/30 Leslie
                this.FilterInit = this.cell.FilterInit;
